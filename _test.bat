...
docker start test_wordpress_apache_php7_db test_wordpress_apache_php7_app
...
docker stop test_wordpress_apache_php7_db test_wordpress_apache_php7_app
docker rm test_wordpress_apache_php7_db test_wordpress_apache_php7_app